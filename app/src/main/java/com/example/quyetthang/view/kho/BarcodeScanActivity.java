...
import static com.example.quyetthang.system.IPC247.SCANDIT_LICENSE_KEY;
...
//        final String result = "Scanned: " + barcode.getData() + " (" + symbology + ")";
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                String currentString = barcode.getData();
                String[] separated = currentString.split(";");
                IPC247.IDQRCode=  separated[0];
                Intent intent = new Intent(BarcodeScanActivity.this, ThongTinPhieuXuatActivity.class);
