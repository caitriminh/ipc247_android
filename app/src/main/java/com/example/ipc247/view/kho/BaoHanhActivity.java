...
import com.example.ipc247.adapter.kho.Adapter_BaoHanh;
            ...
            public void onResponse(Call<ResultInventory> call, Response<ResultInventory> response) {
                ...
                if (result.getStatusCode() == 200) {
                    ...
                    if(lstInventoryTemps.size()==0){
                        TM_Toast.makeText(mContext, "Không tìm thấy thông tin bảo hành sản phẩm.", TM_Toast.LENGTH_LONG, TM_Toast.WARNING, false).show();
                        return;
                    }
                    swiperefresh.setRefreshing(false);
